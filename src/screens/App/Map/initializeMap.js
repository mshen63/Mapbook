...
export const initializeMap = async (currUser, mapboxgl, map, markers, setCurrMarker, mapMarkers, setMapMarkers, canMakeEdits, likedMarkers) => {
    map.addControl(
        new MapboxGeocoder({
